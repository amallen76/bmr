...
\begin{problem}
$2(x + 1) + 3(x - 2) = 13,\quad x = \answer{\frac{17}{5}}$
\begin{feedback}
Apply the distributive property: $2x + 2 + 3x - 6 = 13$. Combine like terms: $5x - 4 = 13$. Add $4$ to both sides: $5x = 17$. Divide both sides by $5$: $x = \frac{17}{5}$.
\end{feedback}
\end{problem}

\begin{problem}
$5(y - 2) + 3 = 2(y + 4) + 7,\quad y = \answer{\frac{22}{3}}$
\begin{feedback}
...
\begin{problem}
$3(z + 2) + 2(z - 1) = 4(z - 3) + 10,\quad z = \answer{-6}$
\begin{feedback}
