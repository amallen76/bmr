...
\begin{feedback}
First, multiply numerator and denominator by $\sqrt{8}$: $\frac{4}{\sqrt{8}} \times \frac{\sqrt{8}}{\sqrt{8}} = \frac{4\sqrt{8}}{8}$. Simplify $\sqrt{8} = 2\sqrt{2}$, so $\frac{4 \times 2\sqrt{2}}{8} = \frac{8\sqrt{2}}{8} = \sqrt{2}$.
\end{feedback}
\end{problem}
