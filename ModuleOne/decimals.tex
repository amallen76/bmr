...
\begin{problem}
What is the place value of the digit $7$ in $0.00781$?\\
$\answer{thousandths}$
\begin{feedback}
...
\wordChoice{
\choice{three and two hundred four hundredths}
\choice[correct]{three and two hundred four thousandths}
\choice{three and twenty-four thousandths}
\choice{three and two thousand four hundredths}
}
\begin{feedback}
The correct answer is the 2nd choice: three and two hundred four thousandths.
\end{feedback}
\end{problem}
...
$\answer{tenths}$
\begin{feedback}
The digit $6$ is in the second position to the right of the decimal point, which represents the tenths place.
\end{feedback}
\end{problem}
